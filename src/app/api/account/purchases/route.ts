...
export async function GET(request: Request) {
  ...
  const fields = "id, download_kind, book_id, book_title, resource_id, resource_title, resource_file_id, download_url, amount_paid, currency, payment_status, paid_at, refunded_at, invoice_number, download_count, last_downloaded_at, created_at";
