...
export const androidApps: CatalogueApp[] = [
  ...
  { packageName: "com.visdar.manuscrits", title: "Reconnaissance de sinogrammes manuscrits", chinese: "汉字手写识别", pinyin: "Hànzì shǒuxiě shíbié", subtitle: "Dessinez. Retrouvez. Comprenez.", description: "Un sinogramme aperçu dans un livre ou sur un menu ? Dessinez-le et explorez les propositions. Les lectures, les définitions françaises et les animations de tracé prolongent la découverte.", features: ["Reconnaissance à partir de la forme dessinée", "Animation de l’ordre des traits", "Lectures, exemples et définitions françaises"], audience: "Pour chercher un sinogramme et enrichir son vocabulaire.", visible: true },
