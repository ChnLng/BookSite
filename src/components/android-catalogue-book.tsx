...
const productUrls: Record<string, string> = {
  "com.visdar.calendrier": "https://www.visdar.fr/outils/calendrier-lunisolaire-chinois-wannianli-android",
  "com.visdar.dialectes": "https://www.visdar.fr/outils/carte-des-dialectes-en-chine-android",
  "com.visdar.classificateur": "https://www.visdar.fr/outils/classificateurs-chinois-liangci-android",
  "com.visdar.cles": "https://www.visdar.fr/outils/cles-des-sinogrammes-android",
  "com.visdar.contextes": "https://www.visdar.fr/outils/dico-contextuel-du-chinois-android",
  "com.visdar.expressions": "https://www.visdar.fr/outils/expressions-idiomatiques-android",
  "com.visdar.temps": "https://www.visdar.fr/outils/exprimer-le-temps-android",
  "com.visdar.heures": "https://www.visdar.fr/outils/heures-du-monde-android",
  "com.visdar.chiffres": "https://www.visdar.fr/outils/nombres-en-chinois-android",
  "com.visdar.manuscrits": "https://www.visdar.fr/outils/reconnaissance-de-sinogrammes-manuscrits-android",
  "com.visdar.couleurs": "https://www.visdar.fr/outils/roue-chromatique-se-pan-android-en-chinois",
  "com.visdar.famille": "https://www.visdar.fr/outils/titres-de-parente-android",
};
...
export function AndroidCatalogueBook({ config, kind }: { config: CatalogueConfig; kind: CatalogueKind }) {
  ...
  const pageIds = ["couverture", "sommaire", ...apps.map(a => a.packageName.split(".").pop()!), ...(business ? ["licences"] : config.testEnabled ? ["avant-premiere"] : [])];
